/**
 * - [[Solver]] is still a work in progress and some available solvers might not work as expected...
- Constraints **only** apply with the solver `seidel` or `jacobi` in [[Solver]]
...
*/
export declare namespace Important { }
